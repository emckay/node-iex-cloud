    ...
    function IEXRequest(fetchFunc, _a) {
        ...
        this.params = function (params) {
            ...
            switch (_this.datatype) {
                case "deep":
                    request = url + "/" + params + "?symbols=" + _this.stockSymbol + "&" + pk;
                    _this.datatype = "stock";
                    _this.sandbox;
                    break;
                case "stock/market/batch":
                    request = url + "?symbols=" + _this.stockSymbols.map(function (symbol) { return symbol; }) + "&types=" + params + "&" + pk;
                    _this.datatype = "stock";
                    _this.sandbox;
                    break;
                case "crypto":
                    request = url + "/" + _this.cryptoCurrency + "/" + params + q + pk;
                    _this.datatype = "stock";
                    _this.sandbox;
                    break;
                case "tops":
